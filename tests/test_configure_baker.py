...
def test_sign_configure_baker_all_parameters(
    ...
    with client.sign_configure_baker(
        ...
        if firmware.is_nano:
            ...
            navigate_until_text_and_compare(
                firmware, navigator, "Continue", default_screenshot_path, test_name + "_1", False, False, NavInsID.USE_CASE_REVIEW_CONFIRM
            )
    ...
    with client.sign_configure_baker_url(
        ...
        if firmware.is_nano:
            ...
            navigate_until_text_and_compare(
                firmware, navigator, "Continue", default_screenshot_path, test_name + "_2", False, False, NavInsID.USE_CASE_REVIEW_CONFIRM
            )
    with client.sign_configure_baker_commission_rate(
        bitmap=bitmap,
        transaction_fee=True,
