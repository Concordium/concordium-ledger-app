...
test(
    '[NANO S] Sign a valid simple transfer with memo',
    setupZemu('nanos', async (sim, transport) => {
        let data = Buffer.from(
            '',
            'hex'
        );
        ...
        await expect(tx).resolves.toEqual(
            Buffer.from(
                '542b8448df7579b94337cea6e169d981c755b2bde8cbd01ea1698b2098b8295a3a401e784664068ec5da74ffe8554aabe2c01ba0f70923f43440f60eba669c0d9000',
                'hex'
            )
        );
    })
...
test(
    '[NANO S] Sign a valid simple transfer',
    setupZemu('nanos', async (sim, transport) => {
        const data = Buffer.from(
            '',
            'hex'
        );
        ...
        await expect(tx).resolves.toEqual(
            Buffer.from(
                '12afcc203c73075ae3e4d89e01844b3fb1b2ecef26565d8c1220e04bddfb7ced0fe38b06a6df22669a20eea4b180ea3d1e1e4ad28a1d2bea29e518ad53f1550d9000',
                'hex'
            )
        );
    })
...
test(
    '[NANO S] Decline to sign a valid simple transfer',
    setupZemu('nanos', async (sim, transport) => {
        expect.assertions(1);
        const data = Buffer.from(
            '',
