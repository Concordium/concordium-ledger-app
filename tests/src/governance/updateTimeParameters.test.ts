...
async function timeParameters(sim: Zemu, transport: Transport, images: string) {
    ...
    await expect(tx).resolves.toEqual(
        Buffer.from(
            '05b6a58557aa005b78ab21ea8ecf3741c5f8efd7ca1e950adf595044b4770ffc9f223e0d87825a268eb6406519110917456efda1bcd7be96de0d3e46d9e52d0e9000',
            'hex'
        )
    );
}
