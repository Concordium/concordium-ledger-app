...
async function addAnonymityRevokerShared(sim: Zemu, transport: Transport) {
    ...
    let data = Buffer.from(
        '080000045100000000000000000000000000000000000000020000000000000000000000000000000a00000000000000640000000063de5da7000000290c0000009e00000001',
        'hex'
    );
...
test(
    ...
    setupZemu('nanos', async (sim, transport) => {
        ...
        const data = Buffer.from(
            '993fdc40bb8af4cb75caf8a53928d247be6285784b29578a06df312c28854c1bfac2fd0183967338b578772398d412018a4afcfaae1ba3ccd63a5b0868a8a9c49deec35a8817d35d0082761b39c0c6bd2357ef997c0f319fefd5b336e6667b7b',
            'hex'
        );
        ...
        await expect(tx).resolves.toEqual(
            Buffer.from(
                '82f58dd72bb0ead83139282032da854b1077a341646db5bacd227554ab985b7814fb9aae9ae2cd6a5557b6e6174c1524a9cf81acae3bf1422cd43e63f5189c099000',
                'hex'
            )
        );
    })
