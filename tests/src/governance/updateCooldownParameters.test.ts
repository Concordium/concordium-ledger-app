...
async function cooldownParameters(sim: Zemu, transport: Transport, images: string) {
    ...
    await expect(tx).resolves.toEqual(
        Buffer.from(
            '5353d3e06fc910caf404e4adb40028ca159c787c558f860d41590afda94e1f866231fad63f8d73eb65b1ab1bc4b9618b0bc681860f377ad329c4c2a36a6136069000',
            'hex'
        )
    );
}
