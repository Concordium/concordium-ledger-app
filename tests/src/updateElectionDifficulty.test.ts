...
test('[NANO S] Update election difficulty', setupZemu('nanos', updateElectionDifficulty));

test('[NANO SP] Update election difficulty', setupZemu('nanosp', updateElectionDifficulty));

test('[NANO X] Update election difficulty', setupZemu('nanox', updateElectionDifficulty));
