...
test('[NANO S] Update baker stake threshold', setupZemu('nanos', updateBakerStakeThreshold));

test('[NANO SP] Update baker stake threshold', setupZemu('nanosp', updateBakerStakeThreshold));

test('[NANO X] Update baker stake threshold', setupZemu('nanox', updateBakerStakeThreshold));
