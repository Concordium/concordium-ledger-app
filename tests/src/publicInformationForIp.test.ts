...
async function identityProvider(
    _device: 'nanos' | 'nanox' | 'nanosp',
    sim: Zemu,
    transport: Transport,
    handleKeyUi: (key: string, extraStep: number) => Promise<any>
) {
    let data = Buffer.from(
        '',
        'hex'
    );
    ...
    await expect(tx).resolves.toEqual(
        Buffer.from(
            'ff3da33b55c1d0763d9d4b823f91af9db75986a548a4bc031b81dee1c4f418a902245f8b0934e3f125163948b2a50bd3661b91dae17442613f0c34707a4789059000',
            'hex'
        )
    );
}
...
test(
    '[NANO S] Public information for identity provider',
