...
static void test_parseKeyDerivationPath() {
    ...
    uint8_t input[37]  = { 0x08, 0xb4, 0xd5, 0xbc, 0xd3, 0xce, 0x78, 0x89, 0xe5, 0x51, 0x2e, 0x0d, 0x43, 0xd2, 0x9e, 0xb2, 0x9a, 0x8e, 0xbf, 0x10, 0xc0, 0x98, 0x47, 0x56, 0xa3, 0x38, 0x2b, 0x71, 0x22, 0xeb, 0x79, 0xfe, 0x5a, 0xb8, 0x80, 0x23, 0xe6};
...
static void test_parseKeyDerivationPath_fails_too_long_path() {
    ...
    explicit_bzero(keyPath->keyDerivationPath, 8);
    uint8_t input[37]  = { 0x09, 0xb4, 0xd5, 0xbc, 0xd3, 0xce, 0x78, 0x89, 0xe5, 0x51, 0x2e, 0x0d, 0x43, 0xd2, 0x9e, 0xb2, 0x9a, 0x8e, 0xbf, 0x10, 0xc0, 0x98, 0x47, 0x56, 0xa3, 0x38, 0x2b, 0x71, 0x22, 0xeb, 0x79, 0xfe, 0x5a, 0xb8, 0x80, 0x23, 0xe6};
    int result = parseKeyDerivationPath(input);
    uint32_t path0 = 0xb4d5bcd3;
