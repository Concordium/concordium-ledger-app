 ...
 * @param p2 If set to 0x01, then the seeds are exported. If set to 0x02, then the BLS keys are exported.
 * 0x00 is not used to ensure that old clients fail when calling this functionality.
 */
