...
fn main() {
    ...
    let mut pool_owner_cooldown = hex::decode("000075300000EA60").unwrap();
    let mut delegator_cooldown = hex::decode("0000000000001000").unwrap();
    ...
    let command = ApduCommand {
        ...
        ins: 64,    // Sign cooldown parameters update
        p1: 0,
        p2: 0,
