...
fn main() {
    ...
    let mut to_public_amount = hex::decode("0000C0A0000F4240").unwrap();
    ...
    let mut transaction_payload = remaining_amount;
    transaction_payload.append(&mut to_public_amount);
    ...
    let command = ApduCommand {
        ...
        p1: 1,
        p2: 0,
        length: transaction_payload.len() as u8,
