...
fn main() {
    ...
    let mut finalization_reward_l_pool = hex::decode("0000EA30").unwrap();
    let mut baking_reward_l_pool = hex::decode("00000200").unwrap();
    let mut transaction_fee_l_pool = hex::decode("0000EA04").unwrap();
    let mut finalization_reward_min = hex::decode("00001001").unwrap();
    let mut finalization_reward_max = hex::decode("0000EA64").unwrap();
    let mut baking_reward_min = hex::decode("0000EA63").unwrap();
    let mut baking_reward_max = hex::decode("0000EA65").unwrap();
    let mut transaction_fee_min = hex::decode("00001000").unwrap();
