...
fn main() {
    ...
    // Note that all the verification keys are pre-fixed by a 1 byte key index.
    ...
    verification_keys.push(hex::decode(format!("{}{}", "01", "46a3e38ddf8b493be6e979034510b91db5448da9cba48c106139c288d658a004")).unwrap());
    verification_keys.push(hex::decode(format!("{}{}", "02", "71d5f16bc3be249043dc0f9e20b4872f5c3477bf2f285336609c5b0873ab3c9c")).unwrap());
